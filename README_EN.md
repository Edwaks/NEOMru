...
**NEOM** is a neural operating ecosystem. It is designed for teams combining knowledge, agents, and operational processes and creates a shared environment for setting goals, coordinating specialized participants, and accumulating results.

- Public URL: https://aisaray.ru/
- Core entities: goals, domains, agents, knowledge, tasks, decisions, and results.
- Key capabilities: ecosystem map, activity domains, specialized agents, knowledge-to-task links, work coordination, decision control, result accumulation.

## Why the Product Is Needed

A real workflow rarely consists of a single action. Users must understand the initial situation, gather information, choose the next step, coordinate a decision, and return to the result later. NEOM provides one domain-specific environment for this work. It preserves context between stages and shows not only an individual item, but also its place in the overall process.

The product’s main value is not the number of screens, but workflow continuity. Goals, domains, agents, knowledge, tasks, decisions, and results are treated as parts of one user journey. New participants understand the current state faster, experienced specialists spend less time matching information manually, and managers gain a clear overview without requiring every step to be retold.
...
The roles Goal owner, Coordinator, and Domain participant work with the same domain model from different perspectives. Consistent names for objects and states reduce ambiguity during handoffs. A responsible participant can reference a specific object and expected result instead of repeating the entire context.

## Main Sections

The public description covers these user capabilities:

- **Ecosystem map** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Activity domains** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Specialized agents** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Knowledge-to-task links** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Work coordination** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Decision control** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Result accumulation** — a distinct part of the workflow, connected to the product model and a clear user outcome.
